...
def generate_matchups(
    ...
    value_cols = ["momentum"] + [f"{f}_baseline" for f in feature_cols] + [f"{f}_track" for f in feature_cols]
    diff_cols  = ["diff_momentum"] + [f"diff_{f}_baseline" for f in feature_cols] + [f"diff_{f}_track" for f in feature_cols]
